...
class LinkedList(): #class linkedlist which as a head node that has been initialized with a none value
  ...
  def search(self, x): #SEARCH FOR AN ELEMENT X IN THE LINKED LIST AND RETURN THE NODE COUNT OF THE ELEMENT: Time Complexity of O(n) because the function loops through LL to find element
    n = self.head
